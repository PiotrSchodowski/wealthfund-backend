...
public class CashService {
    ...
    public ResponseEntity<?> depositCashIntoTheWallet(String userName, String walletName, float valueOfDeposit) {
        ...
        return ResponseEntity.ok("Cash deposit successfully!");
    }
    ...
    public CashEntity depositCash(CashEntity cashEntity, float valueOfDeposit) {
